  ...
  return (
    <main className="min-h-screen bg-slate-50">
      ...
      <div className="max-w-5xl mx-auto px-6 py-16">
        ...
        <div>
          <div className="flex items-center gap-3 mb-6">
            <span className="text-xs bg-slate-200 text-slate-600 font-bold px-3 py-1 rounded-full uppercase">Premium</span>
            <div className="h-px flex-1 bg-gray-200" />
          </div>
          ...
          <div className="rounded-2xl p-8 text-white text-center" style={{ background: "#1e3a5f" }}>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <Link
                href="/signup"
                className="inline-block border border-slate-400 text-slate-200 px-8 py-3 rounded-xl hover:border-slate-300 transition"
              >
                Start Free First
              </Link>
            </div>
