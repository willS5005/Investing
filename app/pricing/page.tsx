      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <div className="inline-flex items-center bg-white border border-gray-200 rounded-xl p-1 mt-8">
            ...
            >
              Yearly <span className="text-emerald-500 ml-1">Save 23%</span>
            </button>
          </div>
        </div>
        ...
        <div className="grid md:grid-cols-2 gap-8">
          ...
          <div className="rounded-2xl p-8 text-white relative overflow-hidden" style={{ background: "#1e3a5f" }}>
            ...
            <div className="text-4xl font-extrabold mb-1">
              {billing === "monthly" ? "$12.99" : "$9.99"}
            </div>
            <div className="text-slate-300 text-sm mb-1">
              {billing === "monthly" ? "per month" : "per month, billed $119.99/year"}
            </div>
            {billing === "yearly" && (
              <div className="text-emerald-300 text-sm mb-6">You save $36/year vs monthly</div>
            )}
            ...
            >
              {loading ? "Loading..." : `Upgrade to Premium — ${billing === "monthly" ? "$12.99/mo" : "$119.99/yr"}`}
            </button>
